<?php include 'include/php/main.php';
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href="include/css/index_6.css">
...
<body>
   ...
   <div class="overlay">
   	...
   	<div id="part_of_menu">
   		<ul class="menu_catg_ul">
   			    ...
   			    <div class="cat_branch"style="float: right;
                                              margin-top: -43px;
                                              margin-right: 88px;
                                              font-size: 1.1em;
                                              font-weight: 500;
   ...
   <!-- end menu bar -->
   	<!-- when we click on user button -->
   	 <div class="none_1 home_page_login">
		<div class="arrow"></div>
		<form>
			<input type="text" name="user name" placeholder="user name"><br>
			<input type="password" name="password" placeholder="..................."><br>
			<button class="home_pa_lo_butn">Login</button><br>
			<div style="text-align: center;
              font-size: 0.8em;
              margin-top: 8px;"><a href="">Forget Password</a></div>
          			<div style="    text-align: center;
              font-size: 0.7em;">For new user?<a href="">Start here</a></div>
		</form>
	</div></div>

	<!-- end of user button process -->
         ...
         <div class="container-fluid">
    	    <div class="row">
    		   ...
    		   <div class="col-lg-2 col-sm-3 col-xs-6 order-sm-2  order-2 nav-3rd container-fluid">
    		   	 <div class="row">
    		   	 	<div class="col-lg-3 col-md-3 nav-3rd-i"><i class="fas fa-shopping-cart"></i><div class="cart-list-number"><?php if($_SESSION['cart_list']){
    		   	 	...
    		   	 	<div class="col-lg-3 col-md-3  order-sm-1"><i class="fas fa-user login_icon"></i></div>
...
<div class="box"><?php 
  ...
  <!--  <div class="mob_bottom">
    ...
    <script src="include/js/jquery.elevateZoom-3.0.8.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="include/js/index_9.js"></script>
</body>
</html>